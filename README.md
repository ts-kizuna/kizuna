...
- **Deprecation support**: mark routes with `deprecated` and fields with `.meta({ deprecated: ... })`. OpenAPI, Swift, and Kotlin pick it up from the contract, and the editor plugin shows strikethroughs
