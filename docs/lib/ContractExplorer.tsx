...
import { BotMessageSquare, Code, FileText, Globe, Server, Smartphone, TriangleAlert } from 'lucide-react';
...
const brandIcons = {
    typescript: <TsLogo key="ts" className="size-3.5" />,
    swift: (
        <svg key="swift" viewBox="0 0 24 24" fill="#f05138" className="size-3.5">
    ...
    kotlin: (
        <svg key="kotlin" viewBox="0 0 24 24" fill="#7f52ff" className="size-3.5">
