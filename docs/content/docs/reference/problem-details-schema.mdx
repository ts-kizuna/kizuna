...
The standard [RFC 9457 Problem Details](https://www.rfc-editor.org/rfc/rfc9457) error response shape used by kizuna. Matches the format produced by [`deny()`](/docs/reference/server-guard#deny-and-problemdetailsschema) in guards and all built-in error responses (404, 405, 415, etc.).
