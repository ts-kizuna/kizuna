...
An **identity** describes a credential your API accepts. A **guard** verifies it and returns who the caller is. Which routes need which identity is [access control](/docs/access-control), one page over.
