...
export function About() {
    return (
        <div className={styles.about}>
            ...
            <p className={styles.body}>
                MCP follows the same idea. Every route becomes a typed tool, straight out of the contract you already have.
            </p>
            <p className={styles.body}>
                The name comes from 絆 (kizuna), a Japanese word for a deep, enduring bond between people. It was chosen because the hard
                part is never writing the code, it is keeping everything you built standing as the API underneath it changes. A single
                contract, bound to everything that depends on it, is what holds that together.
            </p>
