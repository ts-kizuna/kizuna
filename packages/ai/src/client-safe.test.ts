...
// Tool declarations travel in the contract, which the browser imports. The runtime
// half that talks to a provider lives behind its own entry point for this reason.
