...
/**
 * One method per declared permission, reaching every handler as `permission`.
 */
export type PermissionMethods = Record<string, (record?: unknown) => Promise<boolean>>;
