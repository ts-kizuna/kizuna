...
describe('the permissions map, rejected', () => {
    ...
    it('throws on a map key that names no route group', () => {
        ...
        ).toThrow("Permissions map key 'invoices' does not match a route group in the contract.");
    });
        ...
        expect(() =>
            ...
            k.contract({
                ...
                permissions: {
                    members: {
                        '*': 'viewInvoices',
                        removeMember: 'deleteWorkspace',
                    },
                    workspaceInfo: false,
                },
            })
        ).toThrow("Permissions cascade key 'removeMember' does not match a route or group directly under 'members'.");
    });
