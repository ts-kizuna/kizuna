...
[![npm](https://img.shields.io/npm/v/@ts-kizuna/contract?color=blue&label=npm)](https://www.npmjs.com/package/@ts-kizuna/contract)
...
```ts
// server.ts
import { KizunaServer } from '@ts-kizuna/server/express'; // or /fastify, /hono, /next
...
| Package                    | Description                                                         |
| -------------------------- | ------------------------------------------------------------------- |
| `@ts-kizuna/contract`      | Routes, contract definition, and validation                         |
| `@ts-kizuna/server`        | Server runtime and the Express, Fastify, Hono, and Next.js adapters |
