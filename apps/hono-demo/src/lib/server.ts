...
import { createServer, type Router } from '@ts-kizuna/hono';
...
const captureAnalytics = server.requestContext('analytics', ({ c }) => ({
...
const invitesHandlers: Router<typeof contract>['invites'] = {
    getInvite: ({ auth }) => ({
        status: 200,
        body: {
